...
//! Integration testing for the poker_onchain application.

#![cfg(not(target_arch = "wasm32"))]

use poker_onchain::Operation;
...
async fn single_chain_test() {
    let (validator, module_id) =
        TestValidator::with_current_module::<poker_onchain::PokerOnchainAbi, (), u64>().await;
